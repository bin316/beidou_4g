...
/*出厂默认测试代号INDEX*/
#define PROD_CONFIG_FACTORY_DEFAULT_CODE_INDEX    0x1123
/*出厂是否生成随机界桩编号*/
...
/*出厂默认定位搜索倒计时*/
#define PROD_CONFIG_FACTORY_GNSS_SEARCH_TIMEOUT    40
/*出厂默认定位搜索完成倒计时*/
#define PROD_CONFIG_FACTORY_GNSS_SEARCH_COMPLETE_TIMEOUT    10
/*出厂默认网络良好唤醒倒计时(分钟)*/
#define PROD_CONFIG_FACTORY_NET_GOOD_WAKEUP_TIMEOUT_MIN    10
/*出厂默认网络差唤醒倒计时(分钟)*/
#define PROD_CONFIG_FACTORY_NET_BAD_WAKEUP_TIMEOUT_MIN    3
/*出厂默认服务器响应超时 */
